<?php
	...
	$siralama=$_POST['siralama'];
		if($_POST["add"]){
		mysql_query("insert into sorular values (NULL,'".$soru_adi."','".$siralama."','".$_GET["id"]."')")or die(mysql_error());
			$soru_id=mysql_insert_id();
			echo "<center><img src='images/roller.gif'></center>";
			header("Refresh: 2; url=aindex.php?s=sikekle&id=$soru_id&tip=$tip&sik=$sik_sayisi");
		}
?>
<style type="text/css">
.s {
...
<table width="453" align="center"  cellpadding="3" 
  ...
  <tr>
    <td height="16" colspan="2"><div align="center" class="baslik">
      <div align="center" class="tablobaslik">Soru Ekle</div>
    </div></td>
  </tr>
  <tr>
   ...
   <tr>
    ...
    <td width="289"><input type="text" name="sik_sayisi" ></td>
  </tr>
     <tr>
